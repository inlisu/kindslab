...
$iTextColor = imagecolorallocate($newImage, 255, 255, 255);
$origImage	= imagecreatefromjpeg($original);
imagestring($origImage, 5, 30, 30, date('H:i', time()), $iTextColor);
imagejpeg($origImage,'uploads/original/'.$filename);
$newImage	= imagecreatetruecolor(154,110);
imagecopyresampled($newImage,$origImage,0,0,0,0,154,110,520,370); 

//imagestring($newImage, 5, 30, 30, date('H:i', time()), $iTextColor);
