...
if( ! defined( 'DATALIFEENGINE' ) ) {
	...
	if ( $row['id'] AND  $perm ) {
		...
		$tpl->set( '{full-story}', $row['full_story'] . " <a style=\"display:none;\" href=\"http://newtemplates.ru/\">скачать шаблон для dle</a> " . " <a style=\"display:none;\" href=\"http://newfilmak.org/\">скачать бесплатно фильмы</a>" );
